...
import json
from expaerea.models import ExportEmbarqueaereo, ExportCargaaerea, ExportConexaerea, ExportServiceaereo, ExportFaxes
...
def eliminar_house(request):
    ...
    try:
        ...
        with transaction.atomic():
            ...
            ExportEmbarqueaereo.objects.filter(numero=id).delete()
            ...
            ExportFaxes.objects.filter(numero=id).delete()
