...
from impaerea.models import ImportReservas, ImportEmbarqueaereo, ImportServireserva, ImportConexaerea, ImportCargaaerea, \
    ImportAttachhijo, ImportServiceaereo, ImportFaxes
...
class NotasForm(BSModalModelForm):
    ...
    tipo = forms.ChoiceField(
        choices=ImportFaxes.TIPO_CHOICES,
