...
class edit_house(BSModalModelForm):
    ...
    house = forms.CharField(
        widget=forms.TextInput(attrs={'class': 'form-control', 'id': 'house_addh_e', 'required': False}), required=False)
...
class edit_house_general(BSModalModelForm):
    ...
    pago = forms.ChoiceField(
        widget=forms.Select(attrs={'class': 'form-control', "autocomplete": "off", 'required': False,
                                   'max_length': 1, "style": "width:100%;","id":"id_pago_general"}, ),
        required=True, label="Pago",
        choices=(("", "-------"), ("C", "Collect"), ("P", "Prepaid"))
    )

    awb = forms.CharField(widget=forms.TextInput(attrs={
        'class': 'form-control', 'id': 'id_awbhijo_e_general'
    }), label='Master')

    cliente = forms.CharField(widget=forms.TextInput(attrs={
        'class': 'form-control input-sobrepasar', 'id': 'cliente_addh_e_general', 'required': False
    }), required=False)

    house = forms.CharField(widget=forms.TextInput(attrs={
        'class': 'form-control', 'id': 'house_addh_e_general', 'required': False
    }), required=False)

    embarcador = forms.CharField(widget=forms.TextInput(attrs={
        'class': 'form-control input-sobrepasar', 'id': 'embarcador_addh_e_general', 'required': False
    }), required=False)

    vendedor = forms.CharField(widget=forms.TextInput(attrs={
        'class': 'form-control input-sobrepasar', 'id': 'vendedor_addh_e_general', 'required': False
    }), required=False, label='Vendedor')

    consignatario = forms.CharField(widget=forms.TextInput(attrs={
        'class': 'form-control input-sobrepasar', 'id': 'consignatario_addh_e_general', 'required': False
    }), required=False)

    notificar_cliente = forms.DateField(widget=forms.DateInput(attrs={
        'class': 'form-control', 'id': 'notificar_cliente_e_general', 'type': 'date'
    }), label='Notificar Cliente', required=False)

    notificar_agente = forms.DateField(widget=forms.DateInput(attrs={
        'class': 'form-control', 'id': 'notificar_agente_e_general', 'type': 'date'
    }), label='Notificar Agente', required=False)

    etd = forms.DateField(widget=forms.DateInput(attrs={
        'class': 'form-control', 'id': 'etd_e_general', 'type': 'date'
    }), label='ETD', required=False)

    eta = forms.DateField(widget=forms.DateInput(attrs={
        'class': 'form-control', 'id': 'eta_e_general', 'type': 'date'
    }), label='ETA', required=False)
    ...
    transportista = forms.CharField(widget=forms.TextInput(attrs={
        'class': 'form-control input-sobrepasar', 'id': 'transportista_addh_e_general', 'required': False
    }))

    armador = forms.CharField(widget=forms.TextInput(attrs={
        'class': 'form-control input-sobrepasar', 'id': 'armador_addh_e_general', 'required': False
    }), required=False)

    agecompras = forms.CharField(widget=forms.TextInput(attrs={
        'class': 'form-control input-sobrepasar', 'id': 'agecompras_addh_e_general', 'required': False
    }), required=False, label='Ag.Compras')

    ageventas = forms.CharField(widget=forms.TextInput(attrs={
        'class': 'form-control input-sobrepasar', 'id': 'ageventas_addh_e_general', 'required': False
    }), required=False, label='Ag.Ventas')

    origen = forms.CharField(widget=forms.TextInput(attrs={
        'class': 'form-control', 'id': 'origen_addh_e_general'
    }))

    destino = forms.CharField(widget=forms.TextInput(attrs={
        'class': 'form-control', 'id': 'destino_addh_e_general'
    }))

    operacion = forms.ChoiceField(widget=forms.Select(attrs={
        "autocomplete": "off", 'required': False, 'id': 'operacion_editar_general'
    }), required=False, label="Operacion", choices=choice_op, initial='')

    moneda = forms.ChoiceField(widget=forms.Select(attrs={
        "autocomplete": "off", 'required': False, 'id': 'moneda_e_general'
    }), required=False, label="Moneda", choices=(), initial='')

    status_h = forms.ChoiceField(widget=forms.Select(attrs={
        'class': 'form-control', "autocomplete": "off", 'required': False, 'maxlength': 1,
        "style": "width:100%;", 'name': 'status_h_e', 'id': 'status_h_e_general'
    }), required=False, label="Estado", choices=choice_status)

    trafico = forms.CharField(widget=forms.TextInput(attrs={
        'class': 'form-control', 'id': 'trafico_addh_e_general', 'required': False
    }), required=False, initial=0)

    transportista_i = forms.CharField(widget=forms.HiddenInput(attrs={
        'class': 'form-control', 'style': 'width:50px; margin-right:2px;', 'readonly': 'readonly',
        'id': 'transportista_ih_e_general', 'name': 'transportista_ih'
    }), required=False)

    vendedor_i = forms.CharField(widget=forms.HiddenInput(attrs={
        'class': 'form-control', 'style': 'width:50px; margin-right:2px;', 'readonly': 'readonly',
        'id': 'vendedor_ih_e_general', 'name': 'vendedor_ih'
    }), required=False)

    agente_i = forms.CharField(widget=forms.HiddenInput(attrs={
        'class': 'form-control', 'style': 'width: 50px; margin-right:2px;', 'readonly': 'readonly',
        'id': 'agente_ih_e_general', 'name': 'agente_ih'
    }), required=False)

    consignatario_i = forms.CharField(widget=forms.HiddenInput(attrs={
        'class': 'form-control', 'style': 'width:50px; margin-right:2px;', 'readonly': 'readonly',
        'id': 'consignatario_ih_e_general', 'name': 'consignatario_ih'
    }), required=False)

    armador_i = forms.CharField(widget=forms.HiddenInput(attrs={
        'class': 'form-control', 'style': 'width:50px; margin-right:2px;', 'readonly': 'readonly',
        'id': 'armador_ih_e_general', 'name': 'armador_ih'
    }), required=False)

    cliente_i = forms.CharField(widget=forms.HiddenInput(attrs={
        'class': 'form-control', 'style': 'width:50px; margin-right:2px;', 'readonly': 'readonly',
        'id': 'cliente_ih_e_general', 'name': 'cliente_ih'
    }), required=False)

    agventas_i = forms.CharField(widget=forms.HiddenInput(attrs={
        'class': 'form-control', 'style': 'width:50px; margin-right:2px;', 'readonly': 'readonly',
        'id': 'agventas_ih_e_general', 'name': 'agventas_ih'
    }), required=False)

    agcompras_i = forms.CharField(widget=forms.HiddenInput(attrs={
        'class': 'form-control', 'style': 'width:50px; margin-right:2px;', 'readonly': 'readonly',
        'id': 'agcompras_ih_e_general', 'name': 'agcompras_ih'
    }), required=False)

    embarcador_i = forms.CharField(widget=forms.HiddenInput(attrs={
        'class': 'form-control', 'style': 'width:50px; margin-right:2px;', 'readonly': 'readonly',
        'id': 'embarcador_ih_e_general', 'name': 'embarcador_ih'
    }), required=False)

    deposito_i = forms.CharField(widget=forms.HiddenInput(attrs={
        'class': 'form-control', 'style': 'width:50px; margin-right:2px;', 'readonly': 'readonly',
        'id': 'deposito_ih_e_general', 'name': 'deposito_ih'
    }), required=False)
