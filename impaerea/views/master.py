...
from impaerea.models import ImportReservas, ImportEmbarqueaereo
        ...
        if request.method == 'POST':
            ...
            try:
                if form.is_valid():
                    ...
                    vapor_nuevo = vapor_original  # mantener como está si no lo tiene el form

                    # Asignar campos al master
                    ...
                    master.trafico = form.cleaned_data.get('trafico_e', 0) if form.cleaned_data.get('trafico_e') not in [None, ''] else 0
                    master.cotizacion = form.cleaned_data.get('cotizacion_e', 0) if form.cleaned_data.get('cotizacion_e') not in [None, ''] else 0
                    master.manifiesto = form.cleaned_data.get('manifiesto_e', "")
                    ...
                    master.bultosmadre = form.cleaned_data.get('bultos_e', "")
                    ...
                    try:
                        with transaction.atomic():
                            ...
                            if (
                                ...
                                houses = ImportEmbarqueaereo.objects.filter(awb=awb_original)
                                for house in houses:
