...
from consultas_administrativas.forms import  AntiguedadSaldosComprasForm
...
def antiguedad_saldos_compras(request):
    if request.method == 'POST':
        form = AntiguedadSaldosComprasForm(request.POST)
        if form.is_valid():
        ...
        form = AntiguedadSaldosComprasForm()
