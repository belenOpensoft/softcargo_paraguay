...
from impomarit.views.impo_maritima import master_importacion_maritima, source_importacion_master, source_embarque_aereo, \
    master_detail, get_name_by_id
from impomarit.views.master import consultar_seguimientos, add_importacion_maritima, edit_master
...
urlpatterns = [
    ...
    path(r'edit_master/', edit_master, name="edit_master"),
