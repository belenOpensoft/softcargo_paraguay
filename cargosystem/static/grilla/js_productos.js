...
$(document).ready(function()
    {
        ...
        $('#tabla_producto tfoot th').each(function(index) {
            let title = $('#tabla_producto thead th').eq(index).text();
        ...
        table = $('#tabla_producto').DataTable( {
             "stateSave": true,
             dom: 'Btlipr',
//             dom: 'Brtl',
             buttons: [
