...
//});
    ...
    $("#modalSeleccionEmailHouse6").dialog({
        ...
        open: function (event, ui) {
            ...
            $('#buscadorEmailsHouse6').val('');
            $("#listaEmailsHouse6 tr").show();
        }
    });
    $('#buscadorEmailsHouse6').on('keyup', function () {
        let valor = $(this).val().toLowerCase();
        $("#listaEmailsHouse6 tr").filter(function () {
    ...
    table = $('#tabla_house_directo_ea').DataTable({
        ...
        "pageLength": 100,
        "ajax": {
            "url": "/exportacion_aerea/source_embarque_consolidado/",
            'type': 'GET',
            "data": function (d) {
                            ...
                            },
                            {
                                ...
                                click: function () {
                                    if (confirm('¿Confirma la acción de modificar el H B/L?')) {
                                        $('#edit_house_form').trigger('submit');
                                    }
                                },
                            },
    ...
    $('#tabla_house_directo_ea tbody').off('click').on('click', 'tr', function (event) {
        ...
        if (rowData) {
            ...
            localStorage.setItem('tabla_origen', 'tabla_house_directo_ea');
    ...
    $('.email2').click(function () {
        $("#modalSeleccionEmailHouse6").dialog("close");
...
function abrir_modal_mails_d(e) {
    ...
    $("#modalSeleccionEmailHouse6").dialog('open');
}
