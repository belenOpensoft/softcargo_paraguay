...
$(document).ready(function() {
    ...
    $('#item').autocomplete({
        ...
        appendTo: "#proveedoresModal",
        select: function(event, ui) {
             // Guardamos que se seleccionó un item
...
function guardar_factura(){
    ...
    let data=[];
        data={
            ...
            imputar: imputar,
            moneda: moneda,
            saldo_nota_cred: localStorage.getItem('saldo_nota_credito_compra') || $('#id_total').val(),
    ...
    $.ajax({
        ...
        success: function(data) {
            if(!data.success){
                alert('Error al procesar la factura '+data.status);
            }
