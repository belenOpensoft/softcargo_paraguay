...
//});
        ...
        $("#modalSeleccionEmailHouse8").dialog({
        autoOpen: false,
        modal: true,
        width: 400,
        height: 400,
        ...
        open: function (event, ui) {
            ...
            $('#buscadorEmailsHouse8').val('');
            $("#listaEmailsHouse8 tr").show();
        }
    });
$('#buscadorEmailsHouse8').on('keyup', function () {
    let valor = $(this).val().toLowerCase();
    $("#listaEmailsHouse8 tr").filter(function () {
    ...
    table = $('#tabla_house_directo_em').DataTable({
        ...
        "pageLength": 100,
        "ajax": {
            "url": "/exportacion_maritima/source_embarque_consolidado/",
            'type': 'GET',
            "data": function (d) {
...
if (!$('#id_awbhijo').val()) {
    ...
    //mails
        $('.email2').click(function () {
                $("#modalSeleccionEmailHouse8").dialog('close');
...
function abrir_modal_mails_d(e){
    ...
    $("#modalSeleccionEmailHouse8").dialog('open');
...
function filtrar_tabla_houses(data, e) {
    ...
    $.ajax({
        type: "POST",
        url: '/exportacion_maritima/buscar_registros_directos/',
