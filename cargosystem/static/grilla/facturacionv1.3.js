...
function abrir_modalfactura() {
    ...
    $("#facturaM").dialog({
        ...
        beforeClose: function (){
            ...
            localStorage.removeItem('gastos_preventa');
            localStorage.removeItem('preventa');
        }
    }).prev('.ui-dialog-titlebar').remove();
    cargar_arbitraje();
...
function facturar_preventa() {
    ...
    traer_adenda(preventa.posicion,preventa.referencia);
}
...
function traer_adenda(posicion,referencia){

        $.ajax({
            url: "/admin_cont/get_datos_adenda/",
            dataType: 'json',
            type: 'POST',
            data: {'posicion':posicion,'referencia':referencia},
            headers: {'X-CSRFToken': csrf_token},
            success: function (data) {
                $('#id_adenda').text(data.adenda);
            },
            error: function (xhr) {
