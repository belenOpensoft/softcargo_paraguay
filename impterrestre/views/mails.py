...
from impterrestre.models import VEmbarqueaereo, ImpterraCargaaerea, ImpterraEnvases, ImpterraServiceaereo
...
def get_data_email_op(request):
    ...
    if is_ajax(request):
        try:
            ...
            gastos = ImpterraServiceaereo.objects.filter(numero=row_number)
