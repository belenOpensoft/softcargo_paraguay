...
def get_data_email_op(request):
    ...
    if is_ajax(request):
        try:
            ...
            texto = ''
            texto += f'<br>'
            texto, resultado = get_data_html(row_number, row, row2, row3, title, texto, resultado,seguimiento,gastos,embarque,conex,viaje,transportista,master_boolean,gastos_boolean,directo_boolean)
...
def get_data_html(row_number, row, row2, row3, title, texto, resultado,seguimiento,gastos,embarque,conex,viaje,transportista_boolean,master_boolean,gastos_boolean,directo_boolean):
