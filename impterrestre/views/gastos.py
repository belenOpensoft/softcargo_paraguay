...
def add_gasto_master(request):
    ...
    try:
        ...
        if 'id_gasto_id' in form_data and form_data['id_gasto_id']:
            ...
            registro = ImpterraServireserva.objects.get(id=form_data['id_gasto_id'])
        else:
            # Crear un nuevo registro si no existe
            registro = ImpterraServireserva()
    ...
    except ImpterraServireserva.DoesNotExist:
...
def eliminar_gasto_master(request):
    ...
    try:
        id = request.POST['id']
        ImpterraServireserva.objects.get(id=id).delete()
        resultado['resultado'] = 'exito'
...
def eliminar_gasto_house(request):
    ...
    try:
        id = request.POST['id']
        ImpterraServiceaereo.objects.get(id=id).delete()
        resultado['resultado'] = 'exito'
    except IntegrityError as e:
        resultado['resultado'] = 'Error de integridad, intente nuevamente.'
    except Exception as e:
