...
from impterrestre.models import ImpterraReservas, ImpterraEmbarqueaereo, ImpterraServireserva, ImpterraConexaerea, ImpterraEnvases, ImpterraCargaaerea, ImpterraAttachhijo
