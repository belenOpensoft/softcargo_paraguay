...
from expmarit.models import ExpmaritReservas, ExpmaritEmbarqueaereo, ExpmaritServireserva, ExpmaritConexaerea, ExpmaritEnvases, ExpmaritCargaaerea, ExpmaritAttachhijo
