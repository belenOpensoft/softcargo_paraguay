...
from expmarit.models import ExpmaritReservas, ExpmaritEmbarqueaereo, ExpmaritServireserva, ExpmaritConexaerea, \
    ExpmaritEnvases, ExpmaritCargaaerea, ExpmaritAttachhijo, ExpmaritFaxes
...
class NotasForm(BSModalModelForm):
    ...
    tipo = forms.ChoiceField(
        choices=ExpmaritFaxes.TIPO_CHOICES,
...
class add_house(BSModalModelForm):
    ...
    # segunda columna
    viaje = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control',"autocomplete" :"off",'required': False,'max_length': 20,'id':'viaje_house' },),max_length=20,required=False,label="Viaje")
...
class edit_house_general(BSModalModelForm):
    ...
    # primer columna
    pago = forms.ChoiceField(widget=forms.Select(attrs={'class': 'form-control', "autocomplete": "off",
                                                        'required': False, 'max_length': 1,
                                                        "style": "width:100%;", 'id': 'pago_house_e_general'}),
                              required=True, label="Pago",
                              choices=(("", "-------"), ("C", "Collect"), ("P", "Prepaid")))

    awb = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control', 'id': 'id_awbhijo_e_general'}),
                          label='Master')
    cliente = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'form-control input-sobrepasar', 'id': 'cliente_addh_e_general', 'required': False}),
        required=False)
    house = forms.CharField(
        widget=forms.TextInput(attrs={'class': 'form-control', 'id': 'house_addh_e_general', 'required': False}),
        required=False)
    embarcador = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'form-control input-sobrepasar', 'id': 'embarcador_addh_e_general', 'required': False}),
        required=False)
    vendedor = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'form-control input-sobrepasar', 'id': 'vendedor_addh_e_general', 'required': False}),
        required=False, label='Vendedor')
    consignatario = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'form-control input-sobrepasar', 'id': 'consignatario_addh_e_general', 'required': False}),
        required=False)
    etd = forms.DateField(
    ...
    eta = forms.DateField(
        ...
        label='ETA', required=False)
    posicion_h = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'form-control', 'autocomplete': 'off', 'required': True, 'name': 'posicion_h',
    ...
    armador = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'form-control input-sobrepasar', 'id': 'armador_addh_e_general', 'required': False}),
        required=False)
    agecompras = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'form-control input-sobrepasar', 'id': 'agecompras_addh_e_general', 'required': False}),
        required=False, label='Ag.Compras')
    ageventas = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'form-control input-sobrepasar', 'id': 'ageventas_addh_e_general', 'required': False}),
        required=False, label='Ag.Ventas')

    # segunda columna
    viaje = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'form-control', "autocomplete": "off", 'required': False, 'maxlength': 20,
               'id': 'viaje_house_e_general'}), max_length=20, required=False, label="Viaje")
    ...
    operacion = forms.ChoiceField(
        widget=forms.Select(attrs={"autocomplete": "off", 'required': False, 'id': 'operacion_editar_general'}),
    ...
    moneda = forms.ChoiceField(widget=forms.Select(attrs={"autocomplete": "off", 'required': False, 'id': 'moneda_e_general'}),
                               required=False, label="Moneda", choices=(), initial='')
    vapor = forms.CharField(
        widget=forms.TextInput(attrs={'class': 'form-control', 'required': False, 'id': 'vapor_addh_e_general'}),
        required=False)
    ...
    loading = forms.CharField(
        widget=forms.TextInput(attrs={'class': 'form-control', 'id': 'loading_addh_e_general', 'required': False}),
        required=False)
    discharge = forms.CharField(
        widget=forms.TextInput(attrs={'class': 'form-control', 'id': 'discharge_addh_e_general', 'required': False}),
        required=False)
    trafico = forms.CharField(
    ...
    armador_i = forms.CharField(widget=forms.HiddenInput(
        attrs={'class': 'form-control', 'style': 'width:50px; margin-right:2px;', 'readonly': 'readonly',
               'id': 'armador_ih_e_general', 'name': 'armador_ih'}), required=False)
    cliente_i = forms.CharField(widget=forms.HiddenInput(
        attrs={'class': 'form-control', 'style': 'width:50px; margin-right:2px;', 'readonly': 'readonly',
